...
$text = $xmlSms->textSms;
$source = "";
if (sendToTelegram($mobile, $text) == 200)
{
	echo 'Success "00000000-0000-0000-0000-000000000"';
	return;
}
$parts = 1;
...
if($mobile == 'null' || $text == 'null'){echo "empty data!";}
			...
			$params = '?username=callcenter';
			$params = $params.'&password=Passw0rd';
			$params = $params.'&to='.urlencode($mobile);
			$params = $params.'&from=1155';
			$params = $params.'&hex-content='.($message);
			$params = $params.'&coding=8';	
